...
const processadorArch = os.arch();

const nomePc = os.hostname();
...
console.log('👾 Arquitetura do processador: ', processadorArch, ' bits');
console.log('🖥️ Nome do computador: ', nomePc);
console.log('🏠 Diretório home do usuário', diretorioHome);
